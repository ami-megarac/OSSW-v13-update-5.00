...
class SprCpu final : public EaglestreamCpu, public CpuGeneric
{
    ...
    {
        std::regex unc_decode_index("B0._D0._F0_0x104");
    ...
    {
        std::regex cor_decode_index("B0._D0._F0_0x110");
    ...
    [[nodiscard]] std::optional<TORDataGeneric> parseTorData(const json& index)
    {
        ...
        TORDataGeneric tor;
        std::tie(tor.tordump0_subindex0_spr1, tor.tordump1_subindex0_spr1,
            tor.tordump2_subindex0_spr1) = divideTordumps(index["subindex0"]);
        if (!tor.valid2)
        {
            return {};
        }

        std::tie(tor.tordump0_subindex1_spr1, tor.tordump1_subindex1_spr1,
                    tor.tordump2_subindex1_spr1) =
            divideTordumps(index["subindex1"]);
        std::tie(tor.tordump0_subindex2_spr1, tor.tordump1_subindex2_spr1,
                    tor.tordump2_subindex2_spr1) =
            divideTordumps(index["subindex2"]);
        std::tie(tor.tordump0_subindex3_spr1, tor.tordump1_subindex3_spr1,
                    tor.tordump2_subindex3_spr1) =
            divideTordumps(index["subindex3"]);
        std::tie(tor.tordump0_subindex4_spr1, tor.tordump1_subindex4_spr1,
                    tor.tordump2_subindex4_spr1) =
            divideTordumps(index["subindex4"]);
         std::tie(tor.tordump0_subindex5_spr1, tor.tordump1_subindex5_spr1,
                    tor.tordump2_subindex5_spr1) =
            divideTordumps(index["subindex5"]);
        std::tie(tor.tordump0_subindex6_spr1, tor.tordump1_subindex6_spr1,
                    tor.tordump2_subindex6_spr1) =
            divideTordumps(index["subindex6"]);
        std::tie(tor.tordump0_subindex7_spr1, tor.tordump1_subindex7_spr1,
                    tor.tordump2_subindex7_spr1) =
            divideTordumps(index["subindex7"]);

        if (cpuId == "0x806f0")
        {
            tor.tordump0_subindex3_spr11 = tor.tordump0_subindex3_spr1;
        }
        if (cpuId == "0x806f1")
        {
            tor.tordump0_subindex2_spr2 = tor.tordump0_subindex2_spr1;
            tor.tordump0_subindex4_spr2 = tor.tordump0_subindex4_spr1;
            tor.tordump0_subindex7_spr2 = tor.tordump0_subindex7_spr1;
            tor.tordump0_subindex5_spr2 = tor.tordump0_subindex5_spr1;
        }
        if (cpuId == "0x806f2")
        {
            tor.tordump0_subindex1_spr3 = tor.tordump0_subindex1_spr1;
            tor.tordump0_subindex2_spr3 = tor.tordump0_subindex2_spr1;
            tor.tordump0_subindex4_spr3 = tor.tordump0_subindex4_spr1;
            tor.tordump2_subindex0_spr3 = tor.tordump2_subindex0_spr1;
            tor.tordump2_subindex1_spr3 = tor.tordump2_subindex1_spr1;
            tor.tordump2_subindex2_spr3 = tor.tordump2_subindex2_spr1;
            tor.tordump2_subindex3_spr3 = tor.tordump2_subindex3_spr1;
            tor.tordump2_subindex4_spr3 = tor.tordump2_subindex4_spr1;
            tor.tordump0_subindex7_spr2 = tor.tordump0_subindex7_spr1;
            tor.tordump0_subindex5_spr3 = tor.tordump0_subindex5_spr1;
        }
        return tor;
    }
