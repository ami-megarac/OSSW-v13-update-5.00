...
union McerrErrorSource
{
    struct
    {
        uint32_t reserved0 : 14, rmsmi_internal: 1, rmca_internal: 1,
        msmi_internal : 1, reserved1 : 2, msmi_external : 1, reserved2 : 4,
        caterr_interal : 1, reserved3 : 2, caterr_external: 1;
    };
    uint32_t value;
};
...
struct TORDataGeneric
{
    ...
    union
    {
        struct
        {
            uint32_t reserved42: 3, lcs2: 4, reserved43: 3, fsm2: 6, reserved44: 16;
        };
    ...
    union
    {
        struct
        {
            uint32_t reserved45: 31, address_6_6_spr1: 1;
        };
    ...
    union
    {
        struct
        {
            uint32_t reserved46: 31, address_17_17_spr1: 1;
        };
    ...
    union
    {
        struct
        {
            uint32_t reserved47: 31, address_28_28_spr1: 1;
        };
    ...
    union
    {
        struct
        {
            uint32_t reserved48: 31, address_39_39_spr1: 1;
        };
    ...
    union
    {
        struct
        {
            uint32_t reserved49: 31, address_50_50_spr1: 1;
        };
    ...
    union
    {
        struct
        {
            uint32_t reserved50: 6, request_opCode2_1_0: 2, reserved51: 24;
        };
    ...
    union
    {
        struct
        {
            uint32_t request_opCode2_5_3: 3, reserved52: 29;
        };
    ...
    union
    {
        struct
        {
            uint32_t address_16_7_spr1: 10, reserved53: 22;
        };
    ...
    union
    {
        struct
        {
            uint32_t address_27_18_spr1: 10, reserved54: 22;
        };
    ...
    union
    {
        struct
        {
            uint32_t address_38_29_spr1: 10, reserved55: 22;
        };
    ...
    union
    {
        struct
        {
            uint32_t address_49_40_spr1: 10, reserved56: 22;
        };
    ...
    union
    {
        struct
        {
            uint32_t address_51_51_spr1: 1, reserved57: 31;
        };
    ...
    union
    {
        struct
        {
            uint32_t reserved58: 7, target3: 5, reserved59: 10, sad3: 3,
            reserved60: 2, non_coherent2: 1, reserved61: 4;
        };
    ...
    union
    {
        struct
        {
            uint32_t core_id3: 7, reserved62: 20, orig_req2_3_0: 4, reserved63: 1;
        };
    ...
    union
    {
        struct
        {
            uint32_t orig_req2_10_4: 7, reserved64: 25;
        };
        uint32_t tordump0_subindex5_spr2;
    };
    union // SAME FOR 0x806f2
    {
        struct
        {
            uint32_t reserved65: 6, lcs3: 4, reserved66: 4, fsm3: 6, reserved67: 12;
        };
    ...
    union
    {
        struct
        {
            uint32_t address_16_6_spr3: 11, reserved77: 21;
        };
    ...
    union
    {
        struct
        {
            uint32_t address_27_17_spr3: 11, reserved78: 21;
        };
    ...
    union
    {
        struct
        {
            uint32_t address_38_28_spr3: 11, reserved79: 21;
        };
    ...
    union
    {
        struct
        {
            uint32_t address_49_39_spr3: 11, reserved80: 21;
        };
    ...
    union
    {
        struct
        {
            uint32_t address_51_50_spr3: 2, reserved81: 30;
        };
    ...
    union
    {
        struct
        {
            uint32_t orig_req1_10_7: 4, reserved87 : 28;
        };
