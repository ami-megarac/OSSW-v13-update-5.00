...
class SprMcaDecoder : public McaDecoder
{
  ...
  protected:
    ...
    const std::map<uint16_t, const char*> MscodGeneric2 = {
        ...
        {0x5, "Received UnCorr data"},
        {0x6, "Received UnCorr MetaData"},
        {0x7, "Transaction ID Parity Error (APPP)"},
        ...
        {0x200, "DDR5 CA Parity"},
        {0x400, "RPQ Parity (primary) Error"},
        {0x401, "RPQ Parity (buddy) Error"},
        {0x404, "WPQ Parity (primary) Error"},
        {0x405, "WPQ Parity (buddy) Error"},
        {0x408, "RPB Parity (primary) Error"},
        {0x409, "RPB Parity (buddy) Error"},
        {0x800, "DDRT bad request"},
        {0x801, "Read response to an invalid scoreboard entry"},
        {0x802, "unexpected read response"},
        {0x803, "DDR5 completion to an invalid scoreboard entry"},
        ...
        {0x810, "DDRT RPQ REQ PARITY Error"},
        {0x811, "DDRT WPQ REQ PARITY Error"},
        {0x812, "2LM NMFILLWR CAM Error"},
        {0x813, "CMI CREDIT OVERSUB Error"},
        {0x814, "CMI CREDIT TOTAL Error"},
        {0x815, "CMI CREDIT RSVD POOL Error"},
        {0x816, "DDRT RD Error"},
        {0x817, "WDB FIFO Error"},
        {0x818, "CMI REQ FIFO OVERFLOW"},
        {0x819, "CMI REQ FIFO UNDERFLOW"},
        {0x81a, "CMI RSP FIFO OVERFLOW"},
        {0x81b, "CMI RSP FIFO UNDERFLOW"},
        {0x81c, "CMI MISC MC CRDT Errors"},
        {0x81d, "CMI MISC MC ARB Errors"},
        {0x81e, "DDRT WR CMPL FIFO OVERFLOW"},
        {0x81f, "DDRT WR CMPL FIFO UNDERFLOW"},
        {0x820, "CMI RD CPL FIFO OVERFLOW"},
        {0x821, "CMI RD CPL FIFO UNDERFLOW"},
        {0x822, "TME KEY PAR Error"},
        {0x823, "TME CMI MISC Error"},
        {0x824, "TME CMI OVFL Error"},
        {0x825, "TME CMI UFL Error"},
        {0x826, "TME TEM SECURE Error"},
        {0x827, "TME UFILL PAR Error"},
        {0x828, "2LM SB OVERFLOW Error"},
...
class SprMcaBankPcu final : public SprMcaDecoder
{
    ...
    const std::map<uint8_t, const char*> decodeMscod3124 = {
        ...
        {0x7b, "PKGS_SMBUS_VPP_PAUSE_TIMEOUT"},
        {0x7c, "PKGS_SMBUS_MCP_PAUSE_TIMEOUT"},
        {0x7d, "PKGS_SMBUS_SPD_PAUSE_TIMEOUT"},
        {0x80, "PKGC_DISP_BUSY_TIMEOUT"},
        {0x81, "PKGC_INVALID_RSP_PCH"},
        {0x83, "PKGC_WATCHDOG_HANG_CBZ_DOWN"},
        {0x84, "PKGC_WATCHDOG_HANG_CBZ_UP"},
        {0x87, "PKGC_WATCHDOG_HANG_C2_BLKMASTER"},
        {0x88, "PKGC_WATCHDOG_HANG_C2_PSLIMIT"},
        {0x89, "PKGC_WATCHDOG_HANG_SETDISP"},
        {0x8b, "PKGC_ALLOW_L1_ERROR"},
        {0x90, "RECOVERABLE_DIE_THERMAL_TOO_HOT"},
        {0xa0, "ADR_SIGNAL_TIMEOUT"},
        {0xa1, "BCLK_FREQ_OC_ABOVE_THRESHOLD"},
        {0xb0, "DISPATCHER_RUN_BUSY_TIMEOU"},
    };
